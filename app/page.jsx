...
const DEFAULTS = {
  ...
  about: {
    ...
    body:     'At Turf Pro, we specialize in professional irrigation pump installations designed specifically for Grand Lake properties. Based in Afton, Oklahoma, we proudly serve the entire Grand Lake area with a focus on quality, durability, and full GRDA compliance.\n\nIrrigation on Grand Lake isn’t something you can trust to just anyone. The Grand River Dam Authority (GRDA) has strict regulations on pump systems, and since 2011, new submersible pumps are no longer permitted. If an older submersible system fails or is removed, it must be replaced with an above-water pump system to meet current requirements.\n\nAt Turf Pro, we make sure your system is installed the right way the first time—fully compliant, efficient, and built to last.\n\nWhat sets us apart is our commitment to using superior materials and proven installation methods. We install high-quality Goulds and Franklin pumps, paired with high-density polyethylene (HDPE) pipe for maximum durability. Unlike standard PVC used by many competitors, HDPE holds up better against sunlight, weather, and long-term wear. We also use stainless steel fittings instead of galvanized, providing a much longer lifespan in corrosive lake water conditions.\n\nIn addition to irrigation systems, we offer premium sod installation using a Magnum Big Roll installer. This allows us to lay larger, wider rolls of sod with fewer seams, creating a smoother, healthier, and more professional-looking lawn. We are the only local company in the Grand Lake area offering this service.\n\nWe also handle excavation and land improvement projects, including retaining walls and dirt work, always with the same focus on quality and long-term results.\n\nAt Turf Pro, we don’t cut corners. We build systems and landscapes that last—because quality is what sets us apart from the competition.',
    image:    null,
  },
  siteSettings: {
    phone:   '(555) 000-0000',
          ...
          <div className="section-container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="order-1 lg:order-2">
                <p className="section-eyebrow mb-3">About Turf Pro</p>
                <h2 className="section-title mb-6">{about.heading}</h2>
                <div className="text-gray-500 text-lg leading-relaxed mb-8 space-y-4">
                  {about.body.split('\n\n').map((paragraph, idx) => (
      ...
      <footer className="bg-brand-dark text-white">
        <div className="section-container py-16">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <span className="text-xl font-extrabold tracking-tight">
                    TURF <span className="text-brand-red">PRO</span>
                  </span>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/30">
            <p>© {new Date().getFullYear()} Turf Pro. All rights reserved.</p>
            <p>
              Site by{' '}
